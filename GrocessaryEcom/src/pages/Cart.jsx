...
const Cart = () => {
    ...
    const {products,currency,cartItems,removeCartItems,getCartCount,updateCartItems,navigate,getCartAmount} = useAppContext()
            ...
            <div className='flex-1 max-w-4xl'>
                ...
                {cartArray.map((product, index) => (
                    <div key={index} className="grid grid-cols-[2fr_1fr_1fr] text-gray-500 items-center text-sm md:text-base font-medium pt-3">
                        ...
                        <button onClick={()=>removeCartItems(product._id)} className="cursor-pointer mx-auto">
                            <img src={assets.remove_icon} alt='remove' className='inline-block w-6 h-6  rounded-full' />
                        </button>
                    </div>)
                )}
